...
function HomePage() {
    return (
        <div className='bg-red-200 text-gray-600 work-sans leading-normal text-base tracking-normal'>
           <nav id="header" className="w-full z-30 top-0 py-1">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">

            <label form="menu-toggle" className="cursor-pointer md:hidden block">
